...
//Compilación: ""gcc -lm -pthread -o ejemplo_thread ejemplo_thread.c"
//Ejecución: "./a.out 4"
//ADAPTACION DE BUSQUEDA LINEA CON HILOS PARA LA PRACTICA 2
//*****************************************************************
...
{	
	...
	//***************************************************************************************************************************
	//Saber cuál es el tamaño del problema N pthread_create
	//***************************************************************************************************************************	
